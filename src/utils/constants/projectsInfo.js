const projectsInfo = [
  ...
  },
  {
    ...
    media: 'images/airbnb-offer.png',
    info: 'Airbnb offer page clone made using only HTML and SCSS. A showcase of all the page and component styling skills I have acquired.',
  ...
  },
  {
    ...
    media: 'images/hangman.png',
    info: "A game of Hangman with a twist and inspired by Wordle. Made using Reactstrap and ReactJS. A showcase of using local storage to save the game's progress even if you refresh or leave the page.",
    technologies: ['Reactstrap', 'ReactJS'],
    demoURL: 'https://react-hangman-app.vercel.app',
    sourceURL: '',
  },
]
